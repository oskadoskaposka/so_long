...
v1:	fclean all
	@valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes -s ./so_long maps/map1.ber

v2: fclean all
	@valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes -s ./so_long maps/map2.ber

v3: fclean all
	@valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes -s ./so_long maps/map3.ber

v4: fclean all
	@valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes -s ./so_long maps/map4.ber

v5: fclean all
	@valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes -s ./so_long maps/map5.ber

v6: fclean all
	@valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes -s ./so_long maps/map6.ber
